...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-joomla-migration-api?sort=semver)](https://github.com/liberusoftware/module-cms-joomla-migration-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-joomla-migration-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-joomla-migration-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-joomla-migration-api
```
...
<a href="https://github.com/liberusoftware/module-cms-joomla-migration-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-joomla-migration-api" alt="Contributors to liberusoftware/module-cms-joomla-migration-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-joomla-migration-api/graphs/contributors).
